pro create_initial_data_WOLL2,LOGFILE,Y_SHIFT=Y_shift,BINX=binx,BINY=biny
...
spawn,'C:\Users\username\7-Zip\7z.exe x '+cube_filename[J]+ext,/hide
...
;;маскирование плохой строки и смещение по высоте
...
LOGFILE='d:\red.data\LOGS\Mkn79_151207.txt'
;LOGFILE=DIALOG_PICKFILE(/read,path='h:\red_data.pol\LOGS\',FILTER='*.txt')
print,logfile
create_initial_data_WOLL2,LOGFILE,Y_shift=0,biny=2
