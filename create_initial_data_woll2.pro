...
Xstart=20 & Xfinish=4050 ;20 - overscan  ;940 + LP425 ;261    ;1x2
...
for J=0,2 DO BEGIN
 ...
 spawn,'/home/elias/bin/7zzs x '+cube_filename[J]+ext + ' -o'+wdir + '> null'
 ;data type selection
...
for k=0,Ncube-1 do begin
 ...
 FOR J=0,Nexp(k)-1 DO BEGIN
  print,'Processing object file ', files(J,k)
...
LOGFILE=DIALOG_PICKFILE(/read,path='/hdd/Glagol/2019/WOLL-2/20191216/LOGS/',FILTER='*')
print,logfile
create_initial_data_WOLL2,LOGFILE,Y_shift=0
