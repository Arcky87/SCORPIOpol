...
;		res=mpfitpeak(indgen(2*lp+1),slice(Ny/2-lp:Ny/2+lp-1),a,/lorentz) ;& wait, 2
		...
		cgoplot,[a(1)-a(2),a(1)+a(2),a(1)]+Ny/2-lp,[a(0)/2.0+a(3),a(0)/2.0+a(3),a(0)+a(3)]
		cgoplot,[a(1)-9*a(2),a(1)+9*a(2)]+Ny/2-lp,[a(3),a(3)]
			cgoplot,[a(1)-apert(c)/(0.1785*biny),a(1)-apert(c)/(0.1785*biny)]+Ny/2-lp,[-1e4,1e4],thick=2,color='gold'
			cgoplot,[a(1)+apert(c)/(0.1785*biny),a(1)+apert(c)/(0.1785*biny)]+Ny/2-lp,[-1e4,1e4],thick=2,color='gold'
