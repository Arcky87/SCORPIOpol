...
Pro new_Stoks_analyz_event, event
COMMON W_base,base_plot
COMMON DEF_widget,BUTTONS
COMMON GRAPH,spectra,stoks,wave,dir,z,first,type
COMMON FILES,LOG_dir,LOGFILE,pro_dir,wdir,woll,head,output_file
...
'set_PATH':   BEGIN
  			log_dir=DIALOG_PICKFILE(PATH='/',/DIRECTORY)
...
PRO new_Stoks_analyz, GROUP=GROUP
COMMON W_base,base_plot
COMMON GRAPH,spectra,stoks,wave,dir,z,first,type
COMMON DEF_widget,BUTTONS
COMMON FILES,LOG_dir,LOGFILE,pro_dir,wdir,woll,head,output_file
...
XMANAGER, "new_Stoks_analyz", base_plot , GROUP_LEADER=GROUP, /NO_BLOCK
