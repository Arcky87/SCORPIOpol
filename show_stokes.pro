...
; вычисление робастных оценок параметров —токса в окнах по всем экспозици€м
F=fltarr(Npos,Ncube)
...
; вычисление робастных оценок в широкой полосе
print,RC
...
wind=1/wind
;запись спектра на диск
writefits,wdir+'spectra.fts',flux,h
;формирование усредненных спектров
...
;аппроксимаци€ континуума пол€ризованного спектра
f_P_tmp=f_P
...
;аппроксимаци€ широкой компоненты
mul=2.35482
...
;print,g(1),g(2)*mul
;print,s(1),s(2)*mul
;вычисление системной скорости дл€ 3—390.3
z=1.056
