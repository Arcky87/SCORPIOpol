...
pro create_repers2,neon,tra,XPOS=pos,YPOS=ypos,xrep,yrep,TRESH=tresh,EPS=eps,PLOT=plot,WIN=win,TITL=titl
...
xpk=find_peaks(vector,tresh=2 )& Npk(k)=N_elements(xpk)
