...
wdir='h:\red_data.pol\URAN\UMBRIEL+MIRANDA_111118\

cube=readfits(wdir+'obj_lin.fts',h)
a=size(cube)
ima=total(cube(*,0:a(2)/2-1,*,0),3)
;spectra=extraction_spectra(ima,pos=[80],width=20,/plot)
spectra=extraction_spectra(ima,pos=[157],width=20,/broad,/plot)
;spectra=extraction_spectra(ima,pos=[154,167],/plot);,width=20,/broad)
end