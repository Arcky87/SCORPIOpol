...
wdir=['h:\red_data.pol\AGN\Mkn1146_131110\']
wdir=['h:\red_data.pol\1994_UG_160306\']
wdir=['h:\red_data.pol\E1841+643_140324\']
Ndir=N_elements(wdir)

FOR D=0,0 DO BEGIN
;		FOR D=3,Ndir-1 DO BEGIN
print,systime()
print,wdir(D)
wait,1
;goto,cont
...
print,wdir(D) +'target=    '+string(T+1,format='(I1)')+' angle='+angle(p)+' exp='+string(J+1,format='(I2)')
wait,0.01
		;window,2
	;!P.multi=[0,1,1]
		endfor
...
writefits,wdir(D)+'spectra.fit',spectra,h
